...
function doRectanglesOverlap(rect1, rect2) {
  ...
  const top2 = rect1.top + rect1.height;
  const left2 = rect1.left + rect1.width;

  const top3 = rect2.top;
  const left3 = rect2.left;
  const top4 = rect2.top + rect2.height;
  const left4 = rect2.left + rect2.width;

  return !(left2 < left3 || top2 < top3 || left1 > left4 || top1 > top4);
}
...
function getCommonDirectoryPath(/* pathes */) {
  // const newArr = [];
  // let part;
  // console.log(pathes.map((item) => item.split('/')));
  // const newArray = pathes.map((item) => item.split('/'));

  // for (let i = 0; i < newArray[0].length; i++) {
  //   for (let j = 1; i < newArray.length; i++) {
  //     if (newArray[0][i] !== newArray[j][i]) {
  //       part = false;
  //     } else part = true;
  //   }
  //   if (part === true) {
  //     newArr.push(newArray[0][i]);
  //   } else break;
  // }
  // console.log(newArr);
  // return newArr;
